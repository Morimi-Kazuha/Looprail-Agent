...
from pico.agent.effects import EffectJournal, EffectStatus, JournalCorruptionError, canonical_digest
from pico.agent.recovery.models import RecoveryCandidate, RecoveryPlan
...
from pico.agent.recovery.state import RecoveryArtifactError, RecoveryMarker, RecoveryStateStore
...
class RecoveryState:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            "schema": "pico.recovery.projection.v1",
