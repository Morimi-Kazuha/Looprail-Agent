"""
Looprail Agent Executor - replaces OpenClaw CLI subprocess calls.

Drives Looprail's AgentLoop.run_turn() programmatically to execute
...
DEFAULT_PROVIDER = os.environ.get("LOOPRAIL_BENCH_PROVIDER", "custom")
DEFAULT_MODEL = os.environ.get("LOOPRAIL_BENCH_MODEL", "deepseek-v4-flash")
...
async def execute_task(
    ...
    """
    Execute a single benchmark task using Looprail's AgentLoop.
