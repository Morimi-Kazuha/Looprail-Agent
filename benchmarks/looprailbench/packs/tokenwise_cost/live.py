...
TASK_CORPUS_SCHEMA = "looprail.bench.tokenwise-cost.tasks.v1"
REPORT_SCHEMA = "looprail.bench.tokenwise-cost.report.v1"
CURRENT_REPORT_SCHEMA = "looprail.bench.call-efficiency-cost.report.v2"
...
class CampaignConfig:
    ...
    output_root: Path = Path(".looprail/evidence/call-efficiency-cost-current")
