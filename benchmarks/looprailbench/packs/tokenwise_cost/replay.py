...
from looprail.utils.atomic_io import atomic_replace
...
REPLAY_REPORT_SCHEMA = "looprail.bench.call-efficiency-replay.report.v1"
...
def verify_legacy_report(
    ...
    *,
    ...
    report = {
        ...
        "source_looprail_commit": campaign.get("looprail_commit"),
