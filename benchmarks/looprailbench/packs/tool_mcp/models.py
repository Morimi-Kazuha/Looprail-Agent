...
from benchmarks.looprailbench.fixtures.mcp import receipt_payload
from benchmarks.looprailbench.schema import TaskSpec
...
class ToolTarget:
    ...
    def runtime_name(self) -> str:
        return f"mcp_looprailbench_{self.tool_name}"
