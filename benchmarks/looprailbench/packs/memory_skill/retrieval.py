...
from benchmarks.looprailbench.protocol import RetrievalContext, RetrievalExecution
from benchmarks.looprailbench.records import RetrievalStatus
    ...
    def _local_source(self, workspace_id: str) -> LocalSkillSource:
        ...
        metas = [
            SkillMeta(
                ...
                path=Path("/looprailbench") / item.item_id / "SKILL.md",
                content=item.text,
                source="local",
            )
