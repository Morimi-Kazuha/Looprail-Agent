...
from looprail.context_engine.base import AssemblyContext, ContextEngine, Segment
from looprail.context_engine.factory import _build_router
...
def _build_benchmark_context_engine(
    *,
    ...
    from looprail.config.looprail import MemoryConfig, SkillForgeRouterConfig
