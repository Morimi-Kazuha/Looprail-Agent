...
from looprail.spine.scheduler import OriginPools, Scheduler
...
class RuntimeTrialHost:
    ...
    async def _sink(self, event: TurnEvent) -> None:
        ...
        if not isinstance(event, (TurnEnded, TurnFailed)):
            from looprail.spine.events import TurnStarted
    ...
    async def run(self, request: TurnRequest) -> HostTurnObservation:
        ...
        try:
            from looprail.tracing import config as trace_config
            from looprail.tracing import trace as trace_api
