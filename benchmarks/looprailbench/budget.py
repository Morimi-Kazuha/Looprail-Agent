...
_TRIAL_STATE = contextvars.ContextVar[_TrialCallState | None]("looprailbench_provider_trial_state", default=None)
        ...
        *,
        ...
        with self._locked() as handle:
            ...
            self._append_event(
                handle,
                {
                    "schema": "looprail.bench.provider-budget.v1",
                    "kind": "reserved",
...
class BudgetGuardedProvider(LLMProvider):
    ...
    def __init__(
        ...
        *,
        ...
        elif delegate.__class__.__module__.startswith("looprail.providers."):
            raise ProviderBudgetError(
