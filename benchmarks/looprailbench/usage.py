...
_CALL_ROLE = contextvars.ContextVar("looprailbench_call_role", default="other")
_ATTEMPT_KIND = contextvars.ContextVar("looprailbench_attempt_kind", default="initial")
