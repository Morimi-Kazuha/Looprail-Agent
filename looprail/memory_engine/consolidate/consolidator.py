"""Looprail 的 Persistent Agent Memory System。
...
from looprail.utils.helpers import ensure_dir, estimate_message_tokens, estimate_prompt_tokens_chain
...
class MemoryStore:
    ...
    def get_memory_context(
        ...
        *,
        ...
        structured_block = ""
        if structured_hits:
            from looprail.context_engine.segments.render import render_recalled_memory
