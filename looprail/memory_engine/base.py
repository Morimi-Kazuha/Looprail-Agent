...
:class:`MemoryBackend` Protocol（:mod:`looprail.memory_engine.backend`）作为 Plugin Contract。
...
``looprail.context_engine.types``。大量 Importers 使用旧路径，所以 Phase B Cleanup 保持 Location Stable。
"""
