...
Provider 把 Looprail Chat Messages/Function Schema 转成 Codex Responses Flat Items，从 oauth-cli-kit
    ...
    async def chat(
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "Tool install: uv tool install --force 'looprail[channels,tools]'."
            ) from e
