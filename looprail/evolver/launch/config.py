...
The YAML shape:
    ...
    models:                              # optional; omitted -> Looprail's own model
...
from looprail.evolver.launch.state import META_FILENAME
from looprail.evolver.orchestrator.config import (
    AnchorParams,
    Budget,
    OrchestratorConfig,
    Termination,
...
def _validate_work_dir(repo_root: Path, work_dir: Path) -> None:
    ...
    try:
        ...
        with tempfile.NamedTemporaryFile(prefix=".looprail-evolver-write-", dir=work_dir):
            pass
    except OSError as exc:
