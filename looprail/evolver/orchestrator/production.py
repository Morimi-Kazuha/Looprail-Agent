...
from looprail.evolver.judge.llm_client import JudgeLLMBackend
from looprail.evolver.judge.parser import JudgeParseError, parse_pass_fail
from looprail.evolver.judge.prompts import build_pass_fail_messages
...
from looprail.evolver.orchestrator.loop import (
    EvolutionOrchestrator,
    RoundResult,
    summarize_round,
)
from looprail.evolver.orchestrator.nodes.design import design_round
from looprail.evolver.orchestrator.nodes.diagnose import diagnose_round
from looprail.evolver.orchestrator.nodes.semantic import CallFn, SemanticNode
from looprail.evolver.orchestrator.nodes.verdict import draft_verdict
...
from looprail.evolver.tree.node import AppliedPatch, HarnessNode
...
def make_git_commit_apply_fn(
    ...
    *,
    ...
    from looprail.evolver.applier import assert_patch_allowed
...
def make_git_recombine_fn(repo_root: str | Path):
    ...
    """
    from looprail.evolver.orchestrator.archive import CellElite, RecombinantCandidate
    from looprail.evolver.tree import git_ops
    ...
    *,
    ...
    def _record_candidate_artifacts(ctx, cand, outcome):
        ...
        if manifest is None or not candidate_id:
            return
        from looprail.evolver.activation import (
            create_activation_artifacts,
        )
        from looprail.evolver.candidate_evidence import evaluate_candidate_evidence
