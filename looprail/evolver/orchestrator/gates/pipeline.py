...
1. **Gate-f (measurement validity).** Fail closed when either arm has a
   ...
   (:func:`looprail.evolver.orchestrator.scoring.eval_with_infra_rerun`); by the
...
from looprail.evolver.orchestrator.gates.paired import PairedResult, paired_lift
