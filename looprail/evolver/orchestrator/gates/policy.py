...
from looprail.evolver.orchestrator.scoring import EvalFn, EvaluationVerdict, TaskEval
...
if TYPE_CHECKING:
    from looprail.evolver.orchestrator.gates.paired import PairedResult
    from looprail.evolver.orchestrator.gates.pipeline import GateResult
    from looprail.evolver.orchestrator.nodes.screen import ScreenResult
