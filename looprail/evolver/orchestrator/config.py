...
``looprail.evolver.judge.llm_client.build_judge_llm``，使 config 可序列化为 YAML，test 也能不经
...
class OrchestratorConfig:
    ...
    :class:`~looprail.evolver.orchestrator.scoring.EvalBackend` 后；本对象只保存 driver spec、funnel
