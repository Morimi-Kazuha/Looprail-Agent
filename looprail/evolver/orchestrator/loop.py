...
an injected :class:`~looprail.evolver.orchestrator.scoring.EvalBackend`; the
...
from looprail.evolver.orchestrator.archive import (
    CellElite,
    GsmeArchive,
    describe_candidate,
)
from looprail.evolver.orchestrator.config import OrchestratorConfig
from looprail.evolver.orchestrator.gates.fisher import train_mean
...
from looprail.evolver.orchestrator.gates.strategies import PairedTwoSigmaGate
from looprail.evolver.orchestrator.nodes.diagnose import merge_failure_maps
...
from looprail.evolver.orchestrator.sealed.runner import assert_no_test_leak
from looprail.evolver.orchestrator.termination import TerminationTracker
from looprail.evolver.scheduler.anchor_selection import AnchorSelection
from looprail.evolver.tree.node import AppliedPatch, HarnessNode, NodeStatus
...
class EvolutionOrchestrator:
    ...
    def _sentinel_pools(self) -> tuple[list[str], list[str]]:
        from looprail.evolver.analysis.stability_bucket import StabilityBucket
