...
.. code-block::
    ...
    Looprail repo (Git)                    ← code state, white-listed via Git
...
from looprail.evolver.tree.node import (
    AppliedPatch,
    HarnessNode,
    NodeStatus,
)
...
class EvolverTreeStore:
    ...
    .. code-block:: python
        ...
        store = EvolverTreeStore(
            repo_root=Path("/path/to/looprail"),
            nodes_dir=Path("/path/to/looprail/evolver/nodes"),
        )
    ...
    def create_child_node(
        ...
        *,
        ...
        author_email: str = "evolver@looprail.local",
