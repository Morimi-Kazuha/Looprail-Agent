...
模块把 :func:`looprail.evolver.analysis.stability_bucket.compute_stability` 的 per-task stability，
和 :func:`looprail.evolver.analysis.proxy_features.extract_trial_dir` 的 per-trial feature，组合为
:class:`looprail.evolver.scheduler.cold_start_bandit.ColdStartCoverageBandit` 消费的统一
:class:`Trial` view。
...
from looprail.evolver.analysis.proxy_features import (
    ExitStatus,
    ProxyFeatures,
    extract_trial_dir,
)
...
from looprail.evolver.scheduler.cold_start_bandit import Trial
