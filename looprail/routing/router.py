"""Looprail 的 EcoClaw-style Model Router，对外串联分类、评测数据与模型选择。
...
from looprail.routing.classifier import PromptClassifier
from looprail.routing.fetcher import BenchmarkData
from looprail.routing.selector import select_model
from looprail.routing.types import RoutingProfileName, SelectionResult
