# Hermes ``system_and_3`` vs Looprail ``CacheOptimizer`` — Head-to-Head
...
> `AgentLoop.run_turn`. Looprail labels are preserved as experiment variants.
...
|:---|:---|:---|:---|:---|
| **V1 baseline** | — | — | — | — |
| **V2 Looprail v2** | tools[-1] (if tools) | system tail | rolling msg[-2] | rolling msg[-1] |
...
| V2_looprail | tools+sys+rolling_tail | 8 | 24 | 4,529 | 27,656 | 37 | $0.025908 | -73.3% | 85.9% |
...
#### V2_looprail (tools+sys+rolling_tail, sys=12,990ch, tools=0)
...
- **V2_looprail** (tools+sys+rolling_tail): **73.3%** savings vs baseline
- **V3_hermes** (sys+last_3): **73.3%** savings vs baseline
- **Winner: V3_hermes** (Looprail vs Hermes: +0.2%)
...
| V2_looprail | tools+sys+rolling_tail | 12 | 63 | 26,356 | 97,508 | 717 | $0.139031 | -63.7% | 78.7% |
...
#### V2_looprail (tools+sys+rolling_tail, sys=13,000ch, tools=3)
...
- **V2_looprail** (tools+sys+rolling_tail): **63.7%** savings vs baseline
- **V3_hermes** (sys+last_3): **63.6%** savings vs baseline
- **Winner: V2_looprail** (Looprail vs Hermes: -0.2%)
...
| V2_looprail | tools+sys+rolling_tail | 12 | 54 | 20,296 | 78,962 | 444 | $0.106621 | -64.9% | 79.5% |
...
#### V2_looprail (tools+sys+rolling_tail, sys=12,826ch, tools=1)
...
- **V2_looprail** (tools+sys+rolling_tail): **64.9%** savings vs baseline
- **V3_hermes** (sys+last_3): **66.4%** savings vs baseline
- **Winner: V3_hermes** (Looprail vs Hermes: +4.1%)
