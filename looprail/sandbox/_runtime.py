"""Internal Helper：构造 Rooted at Looprail Data Dir 的 BoxLite Runtime。

Looprail 内所有 BoxLite Usage，包括 `BoxliteExecutor` 与 `SandboxDebugServer`，都通过这里取得 Runtime，
...
def get_boxlite_runtime() -> "_boxlite_t.Boxlite":
    ...
    from looprail.config.paths import get_sandbox_dir
