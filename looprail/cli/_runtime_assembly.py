...
from looprail.agent.loop.recovery import limits_from_defaults
...
def assemble_runtime(
    ...
    *,
    ...
    from looprail.cli._plugin_stack import (
    ...
    try:
        ...
        agent_loop = AgentLoop(
            ...
            context_config=looprail_config.context,
            context_engine_factory=context_engine_factory,
            runtime_config=looprail_config.runtime,
            interactive=interactive,
            backend=backend,
            memory_config=looprail_config.memory,
            skill_forge_router_config=looprail_config.skill_forge.router,
