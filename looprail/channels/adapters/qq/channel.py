...
本模块解决的是 QQ 平台事件如何进入 Looprail Runtime、Runtime 文本回复又如何回到原会话。
...
from looprail.channels.adapters.qq import parsing
from looprail.channels.base import ChannelBase
from looprail.channels.errors import transient_network
from looprail.channels.media import safe_name
from looprail.config.schema import QQConfig
