"""把 WeCom（Enterprise WeChat）AI bot 消息接入 Looprail Runtime。
...
from looprail.channels.media import safe_name, save_media_bytes
from looprail.config.schema import WecomConfig
