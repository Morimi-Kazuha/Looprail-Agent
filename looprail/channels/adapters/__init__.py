...
每个 Subpackage 提供导出 :class:`~looprail.channels.contract.ChannelSpec` 的 ``spec.py``，由
:mod:`looprail.channels.registry` 自动发现，无需 Manual Registration。Spec Factory 延迟 Heavy SDK Import；
