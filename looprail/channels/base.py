...
:mod:`looprail.channels.contract` 的 ``Channel`` Protocol，而不是继承关系。Inbound Normalization 属于 `Intake`，
...
from looprail.channels.contract import Capabilities
...
class ChannelBase:
    ...
    Intake。系统依赖 :mod:`looprail.channels.contract` ``Channel`` Protocol，继承这里只为 Reuse，Conformance
    ...
    def is_allowed(self, sender_id: str) -> bool:
        ...
        """
        from looprail.auth.allowlist import is_allowed as _check
