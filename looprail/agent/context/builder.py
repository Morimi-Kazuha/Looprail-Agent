...
from looprail.product import PRODUCT_LOGO, PRODUCT_NAME
from looprail.security.trust import wrap_untrusted
from looprail.utils.helpers import build_assistant_message, detect_image_mime
...
{skills_summary}""")
    ...
    def _get_identity(self) -> str:
        """渲染核心 Identity、Runtime、Workspace 与 Looprail Guidelines Section。
