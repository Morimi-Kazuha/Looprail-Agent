...
from looprail.security.network import validate_resolved_url, validate_url_target
    ...
    async def execute(self, query: str, count: int | None = None, **kwargs: Any) -> str:
        if not self.api_key:
            return (
                ...
                "~/.looprail/config.json under tools.web.search.apiKey "
