...
``looprail.agent.effects``.  This adapter adds the observation axis and emits a
...
from looprail.agent.effects import EffectClass, EffectRecord, EffectStatus, utc_now
...
class RecoveryPlanner:
    ...
    PLAN_VERSION = "looprail.recovery.v1"
