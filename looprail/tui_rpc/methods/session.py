...
from looprail.tui_rpc.methods.image import clear_pending_images
from looprail.tui_rpc.methods.system import _looprail_version

if TYPE_CHECKING:
    from looprail.agent.loop.main import AgentLoop
...
# site-packages 的 dist-info。system._looprail_version() 已兼容源码检出环境中的 PackageNotFoundError。
_LOOPRAIL_VERSION = _looprail_version()
...
def register_session_methods(
    ...
    *,
    ...
    该实现镜像 :func:`looprail.tui_rpc.methods.turn.register_turn_methods`：用单参数 closure
