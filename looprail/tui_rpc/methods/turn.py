"""实现把 TUI request 接入 Looprail Spine 的 ``turn.*`` handlers。
...
from looprail.spine import ChatType, Origin, Source, TurnHandle, TurnRequest
from looprail.spine.scheduler import Scheduler, SchedulerDrainingError
from looprail.tui_rpc.errors import RpcError, TurnInProgressError
from looprail.tui_rpc.methods.image import consume_pending_images, pending_images
