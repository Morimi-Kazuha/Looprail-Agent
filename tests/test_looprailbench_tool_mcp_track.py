...
from benchmarks.looprailbench.packs.tool_mcp import (
...
from benchmarks.looprailbench.packs.tool_mcp.runner import (
...
from looprail.spine import ToolEvent, ToolPhase
...
def test_target_call_normalization_keeps_invalid_unknown_and_exact_repeats() -> None:
    ...
    events = (
        ...
        ToolEvent(
            ...
            name="tool_call",
            arguments={
                "name": "mcp_looprailbench_catalog_probe_99",
                "arguments": {},
            },
        ),
        ToolEvent(
        ...
        for repetition in range(repetitions):
            ...
            for variant_id, schema_tokens, visible_names in (
                (
                    "tool-mcp-all-tools",
                    1_000,
                    ["mcp_looprailbench_catalog_probe_00"],
                ),
                (
