...
from pico.agent.effects import EffectClass, EffectJournal, EffectRecord, EffectStatus, JournalCorruptionError
...
def test_local_write_read_failure_is_unknown_not_missing(tmp_path, monkeypatch) -> None:
    ...
    import pico.agent.recovery.observations as observation_module
...
def test_phase0a_record_gets_compatibility_logical_effect_id() -> None:
