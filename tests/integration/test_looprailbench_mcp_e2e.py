...
from benchmarks.looprailbench.records import TrialKey, TrialStatus, VerificationState
...
async def test_real_stdio_mcp_smoke_crosses_search_call_and_receipt(
    ...
    assert result.receipt["tool"] == result.called_target_name.removeprefix("mcp_looprailbench_")
