...
from benchmarks.looprailbench.scorecard_campaign import (
...
def test_makefile_exposes_scorecard_estimate_and_ship() -> None:
    ...
    assert "looprailbench-scorecard-estimate:" in makefile
    assert "looprailbench-scorecard-ship:" in makefile
